...
class ReplaceAuthorizationWithOAS3SecurityRequirementAnnotationTest implements RewriteTest {

	@Override
	public void defaults(final RecipeSpec spec) {
		spec.recipe(new ReplaceAuthorizationWithOAS3SecurityRequirementAnnotation()).parser(
